...
export function KanbanCard({ task, onDragStart, onEdit, onDelete, onView, highlighted }: {
  task: Task; onDragStart: () => void; onEdit: () => void; onDelete: () => void; onView: () => void; highlighted?: boolean;
}) {
  ...
  return (
    <div
      ...
      tabIndex={0}
      className={cn(
        'group cursor-grab select-none rounded-lg border border-border bg-card p-3 shadow-sm transition-shadow hover:shadow-md active:cursor-grabbing active:opacity-60',
